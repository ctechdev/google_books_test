...
import 'package:google_books_test/constants/keys.dart';
import 'package:google_books_test/constants/strings.dart';
...
class SignInPageContents extends StatelessWidget {
  const SignInPageContents(
      {Key? key, required this.viewModel, this.title = 'Books App'})
      : super(key: key);
